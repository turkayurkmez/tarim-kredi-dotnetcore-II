...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<AllCompany> AllCompanies { get; set; }
    ...
    public virtual DbSet<CustomersFromGermany> CustomersFromGermanies { get; set; }

    public virtual DbSet<DetailedOrder> DetailedOrders { get; set; }

    public virtual DbSet<Employee> Employees { get; set; }

    public virtual DbSet<GetStockColorFlag> GetStockColorFlags { get; set; }
    ...
    public virtual DbSet<SalesForCountry> SalesForCountries { get; set; }
    ...
    public virtual DbSet<VolumeByDate> VolumeByDates { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AllCompany>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("AllCompanies");
        ...
        modelBuilder.Entity<CustomersFromGermany>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("CustomersFromGermany");
        ...
        {
            entity.HasIndex(e => e.FirstName, "IX_Employee_LastName");
        ...
        modelBuilder.Entity<GetStockColorFlag>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("GetStockColorFlag");

            entity.Property(e => e.ColorState)
                .HasMaxLength(5)
                .IsUnicode(false);
            entity.Property(e => e.ProductName).HasMaxLength(40);
            entity.Property(e => e.UnitPrice).HasColumnType("money");
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.ToTable("Order Details", tb => tb.HasTrigger("autoStockUpdate"));
            ...
            entity.HasIndex(e => new { e.ProductId, e.Quantity, e.UnitPrice }, "ix_Order_Details").IsDescending(false, true, false);
        ...
        {
            entity.ToTable(tb => tb.HasTrigger("tr_InsOfDelete"));
        ...
        modelBuilder.Entity<SalesForCountry>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("SalesForCountry");

            entity.Property(e => e.ShipCountry).HasMaxLength(15);
            entity.Property(e => e._1996)
                .HasColumnType("money")
                .HasColumnName("1996");
            entity.Property(e => e._1997)
                .HasColumnType("money")
                .HasColumnName("1997");
        ...
        modelBuilder.Entity<VolumeByDate>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VolumeByDate");
